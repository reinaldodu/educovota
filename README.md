...
1. Descarga el archivo comprimido `.7z` de la [**última versión**](https://github.com/reinaldodu/educovota/releases/download/v.25.7/EducoVotaPortable.7z) desde la sección Releases de este repositorio (para descomprimir el archivo utilice [7-Zip](https://www.7-zip.org/)).
